...
library(stars);library(dplyr);library(ggplot2);library(viridis);library(here);library(ggrepel);library(rlang);library(units);library(knitr);library(glue); library(gt); library(officer);library(officedown);library(dplyr); library(abind); library(sf);library(rmarkdown);library(shiny)
...
```{r, echo=FALSE}
#Need to update with figure name/location to be correct figure
fig1 <- paste0("data/", params$name, "/MACA-map-zoomed-in.png")
```
