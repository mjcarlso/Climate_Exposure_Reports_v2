...
library(stars);library(dplyr);library(ggplot2);library(ggthemes);library(viridis);library(here);library(ggrepel);library(rlang);library(units);library(knitr);library(purrr);library(glue); library(gt); library(officer);library(officedown);library(dplyr); library(abind); library(sf)
...
![**Figure 1.** Historical trends in annual average temperature (upper plot) and annual total precipitation (lower plot) for `r params$name` from 1895-2022. Black points show yearly values while the red line represents the 10-year rolling average. Blue lines are linear regressions for the entire period recod, up to 1970, and 1970-present. Solid lines are significant trends (i.e., p\<0.05); dashed lines are not statistically significant.](data/){width="300"}
...
![**Figure 4.** Metrics of extreme temperature at `r params$name`. The upper plot represents the number of days per year when maximum temperature exceeds the historical 95th percentile at `r params$name` historically and in both climate futures. The lower plot is the number of days per year when heat index reaches 'dangerous' levels (103-124 °F).](data/){width="300"}
...
![**Figure 5.** Upper plot: Modeled recurrence intervals (annual) for 24-hour precipitation events for each climate future and the historical period. The x axis indicates the return period expected for the amount of precipitation received in a day indicated on the y axis (see Methodological note for details). Lower plot: Number of days per year in which rainfall ≥ HistPrecip99 inches, the historical 95th-percentile event.](data/){width="300"}
...
![**Figure 7.** The upper plot shows historical (gray lines; 1979-2020) and climate futures (blue and red lines; 2023-2099) of mean annual climatic water deficit in `r params$name`. Both metrics correlate strongly with wildfire risk (citation from Thoma). The lower plot shows (annual) distributions of climatic water deficit relative to annual actual evapotranspiration historically and for each climate future.](data/){width="300"}
...
+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-------------------------------------------------+
| Draft Desired Condition                | How will climate change affect this desired condition under the "Warm-Wet" scenario?                                                    | Is the Desired Condition achievable under the "Warm-Wet" scenario?        | How will climate change affect this desired condition under the "Hot-Dry" scenario?                                                                       | Is the Desired Condition achievable under the "Hot-Dry" scenario? | Revise Desired Condition?                       |
|                                        |                                                                                                                                         |                                                                           |                                                                                                                                                           |                                                                   |                                                 |
|                                        |                                                                                                                                         |                                                                           |                                                                                                                                                           |                                                                   | Remove Desired Condition?                       |
+========================================+=========================================================================================================================================+===========================================================================+===========================================================================================================================================================+===================================================================+=================================================+
| DESIRED CONDITIONS:COMMON TO ALL UNITS |                                                                                                                                         |                                                                           |                                                                                                                                                           |                                                                   |                                                 |
+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-------------------------------------------------+
| No net loss of wet meadows and fens    | Marginal wetlands may convert to uplands due to warmer conditions. Some wetlands could expand or remain stable under wetter conditions. | No net loss is probably not feasible, but minimal loss might be possible. | No practical way to keep al meadows. Marginal wetlands will convert to uplands. All wetlands could periodically dry out under extreme drought conditions. | No. No net loss is not attainable.                                | Revision: Minimize loss of high value wetlands. |
+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-------------------------------------------------+
|                                        |                                                                                                                                         |                                                                           |                                                                                                                                                           |                                                                   |                                                 |
+----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-------------------------------------------------+
